<template>
  <VFormControl class="v-input" :error="error" :label="label" :required="required" :class="{ large, disabled, multiline }" outline>
...
import VFormControl, { VFormControlProps } from './VFormControl.vue';
